...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/layout/mainlayout.css"/>
    <link rel="stylesheet" type="text/css" href="css/layout/navmenu.css"/>
    <!--- Bootstrap 5 CSS --->
    <link rel="stylesheet" href="bootstrap-5.3.6-dist/css/bootstrap.min.css"/>
    <!--- Bootstrap Icons --->
    <link rel="stylesheet" href="bootstrap-icons-1.11.3/bootstrap-icons.css">
     <!--- JQuery --->
...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="text-white p-3 main-header">
      <div class="d-flex">
        ...
        &nbsp;&nbsp;&nbsp;
        <div class="p-0 about">
          <a href="#" class="a-header" onclick="showMessageModal(onLogout, 'Are you sure you want to log out?', 'Log out', MessageType.QUESTION)">Logout</a>
        </div>
      </div>
    </header>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-9 col-lg-10 p-4">
          ...
          <main>
            ...
            <cfinclude template="messagemodal.cfm" >
          </main>
        </div>
      </div>
    </div>
...
<!--- Include custom JS for the main layout. --->
<script type="text/javascript" language="javascript" src="./js/layout/mainlayout.js"></script>
<!--- Check if exists session --->
<cfinclude template="../access/checksession.cfm">